...
export default function Auth() {
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      >
        <Card className="glass shadow-xl rounded-2xl overflow-hidden">
          <CardHeader className="space-y-1 text-center pb-4">
            ...
            <CardTitle className="text-3xl font-extrabold tracking-tight text-gradient-primary">
              {t("auth.title")}
            </CardTitle>
          ...
          {/* Tab switcher */}
          <div className="grid grid-cols-2 mx-6 rounded-xl bg-muted p-1 mb-4">
            <button
              type="button"
              onClick={() => !isSignUp || switchMode()}
              data-testid="tab-login"
              className={`py-2 rounded-lg font-semibold uppercase text-xs tracking-wider transition-all ${
            ...
            <form onSubmit={handleAuth} className="grid gap-4" noValidate>
                  ...
                  >
                    <div className="grid gap-1.5">
                      ...
                      <Input
                        ...
                        className="rounded-xl border focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:border-primary bg-background/60 h-11"
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  className="rounded-xl border focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:border-primary bg-background/60 h-11 lowercase"
                  autoComplete="email"
                  autoCapitalize="none"
                  spellCheck={false}
                  inputMode="email"
              ...
              <div className="grid gap-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="rounded-xl border focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:border-primary bg-background/60 h-11 pr-12"
              ...
              <AnimatePresence>
                {error && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -6 }}
                    className="text-destructive text-xs font-semibold border border-destructive/50 bg-destructive/10 rounded-lg p-2.5 flex items-start gap-2"
              ...
              <Button
                ...
                className="w-full gradient-primary text-primary-foreground hover:opacity-90 uppercase font-bold tracking-wider rounded-xl mt-1 h-12 shadow-md hover:shadow-lg transition-all disabled:opacity-60 disabled:cursor-not-allowed"
              >
