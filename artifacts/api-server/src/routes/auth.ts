...
router.patch("/auth/profile", async (req, res): Promise<void> => {
  ...
  if (parsed.data.username != null) updates.username = parsed.data.username.trim();
  if (parsed.data.displayName != null) updates.displayName = parsed.data.displayName.trim();
  if (parsed.data.city != null) updates.city = parsed.data.city.trim().toLowerCase();
